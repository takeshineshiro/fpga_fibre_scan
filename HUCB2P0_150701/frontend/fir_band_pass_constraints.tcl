...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "fir_band_pass_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "fir_band_pass_st" "LOGIC ELEMENTS"
}
add_fir_constraints
